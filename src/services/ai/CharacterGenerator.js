/**
 * FAUST - 4-Layer Deep Character Generator
 * Generates comprehensive character profiles using AI with psychological,
 * transactional, archetypal, and narrative layers.
 */
(function(window) {
  'use strict';
  ...
  class CharacterGenerator {
    ...
    async generateCharacter(params = {}) {
      ...
      try {
        ...
        const response = await window.callAIProvider({
