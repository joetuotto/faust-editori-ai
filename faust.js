...
function FaustEditor() {
  ...
  const [targets, setTargets] = useState({
    project: 80000,      // Koko projektin sanamäärätavoite
    daily: 1000,         // Päivittäinen tavoite
  ...
  return e(React.Fragment, null,
    ...
    e('div', { 
      ...
      showSidebar && e('div', {
        ...
        e('div', {
          className: 'absolute top-0 right-0 bottom-0 w-1 cursor-col-resize hover:bg-[var(--faust-gold)] transition-colors',
          style: {
            background: 'transparent',
            zIndex: 10
          },
              ...
              return e('div', null,
                ...
                e('div', {
                  ...
                  e('div', {
                    ...
                    e('div', null, '• Kirjoita [[hahmon nimi]] luodaksesi linkin'),
                    e('div', null, '• Kirjoita [[paikan nimi]] linkittääksesi paikkaan'),
                    e('div', null, '• Hover näyttää entiteetin tiedot (tulossa)')
                  )
                )
              );
            })()
            ...
            (project.characters || []).length === 0 ?
              ...
              (project.characters || []).map(char =>
                e('div', {
                  ...
                  // Backlinks - Näytä missä hahmoa mainitaan
                  (() => {
                  ...
                  e('button', {
                    ...
                    onClick: () => {
                      ...
                      const prompt = technique.prompt
                        .replace(/\{\{CONTENT\}\}/g, activeItem?.content || '[Ei sisältöä]')
...
`).join('\n') || 'Ei hahmoja määriteltynä')
      ...
      aiAssistantOpen && e('aside', {
        ...
        e('div', { 
          ...
          ['chat', 'quick', 'techniques'].map(tab => {
            const labels = { chat: 'Chat', quick: 'Pikatoiminnot', techniques: 'Tekniikat' };
              ...
              e('div', { key: categoryKey, className: 'space-y-2' },
                ...
                category.techniques.map(technique =>
                  e('button', {
                    ...
                    onClick: () => {
                      const activeItem = getActiveItem();
                      const prompt = technique.prompt.replace(/\{\{CONTENT\}\}/g, activeItem?.content || '[Ei sisältöä]');
                      setAiPrompt(`${technique.name}: ${technique.description}`);
                      callAIAPI(prompt, false);
                      setAiPanelTab('chat'); // Switch to chat to see response
                    },
...
console.log('✅ FaustEditor:', typeof FaustEditor);
...
try {
  ...
  document.body.innerHTML = '<div style="padding:20px;color:white;background:#1e1e1e;font-family:monospace"><h1>Error</h1><pre>' + error.toString() + '</pre><pre>' + error.stack + '</pre></div>';
}
